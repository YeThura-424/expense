	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<form class="form-horizontal" method="GET" action="{{route('borrowreport')}}">
					@csrf
					...
					<div class="form-group row">
						...
						<div class="col-md-8">
							<select class="form-control" name="status" placeholder="Choose Status">
								@if ($status == 'get')
									@if ($con2 == 'Pending')
									<option value="choose">None</option>
...
<main class="app-content">
	<div class="app-title">
		<div>
			<h1><i class="fa fa-file-text"></i>Borrow Detail Report</h1>
		</div>
		<ul class="app-breadcrumb breadcrumb side">
			<li class="breadcrumb-item"><a href="/" title="Home"><i class="fa fa-home fa-lg"></i></a></li>
			<li class="breadcrumb-item">Report</li>
			<li class="breadcrumb-item">Borrow Detail Report</li>
		</ul>
	</div>
	<div class="row">
		<div class="col-md-12">
			<div class="tile">
				...
				<div class="tile-body">
					<div class="row">
						<div class="col-md-1">
							@if($status == "get")
							<form class="form-horizontal" method="GET" action="{{route('borrowexport')}}">
								@csrf
						...
						<div class="col-md-1">
							@if($status == "get")
							<form class="form-horizontal" method="GET" action="{{route('borrowpdfexport')}}">
								@csrf
								<input type="hidden" name="from" value="{{$from}}">
								<input type="hidden" name="to" value="{{$to}}">
								<input type="hidden" name="name" value="{{$con1}}">
					...
					<table class="table">
						<thead>
							<tr>
								<th colspan="7" class="text-center text-success">Borrow Details From {{$from}} To {{$to}}</th>
							</tr>
							<tr>
								<th>No.</th>
								<th>Date</th>
