...
<main class="app-content">
	<div class="app-title">
		<div>
			<h1><i class="fa fa-edit"></i>Create Use list</h1>
		</div>
		<ul class="app-breadcrumb breadcrumb">
			...
			<li class="breadcrumb-item">Create Use List</li>
		</ul>
	</div>
	<div class="row">
		...
		<div class="col-md-6">
			<div class="tile">
				...
				@endif
				<h3 class="tile-title text-center">Add New Use List</h3>
				<div class="tile-body">
					<form class="form-horizontal" method="POST" action="{{route('form.store')}}">
						...
						<div class="form-group row">
							...
							<div class="col-md-8">
								<select class="form-control" placeholder="Choose Category" name="category">
									<option></option>
						...
						<div class="row">
							...
							<div class="col-md-3 col-md-offset-3">
								<a class="btn btn-primary" href="/form"><i class="fa fa-fw fa-lg fa-check-circle"></i>Cancel</a>
							</div>
							<div class="col-md-3 col-md-offset-3">
