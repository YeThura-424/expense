...
<main class="app-content">
	<div class="app-title">
		<div>
			<h1><i class="fa-solid fa-edit"></i>Create Lend list</h1>
		</div>
		<ul class="app-breadcrumb breadcrumb">
			...
			<li class="breadcrumb-item">Create Lend List</li>
		</ul>
	</div>
	<div class="row">
		...
		<div class="col-md-6">
			<div class="tile">
				...
				@endif
				<h3 class="tile-title text-center">Add New Lend List</h3>
				<div class="tile-body">
					<form class="form-horizontal" method="POST" action="{{route('lend.store')}}" enctype="multipart/form-data">
						@csrf
						...
						<div class="row">
							...
							<div class="col-md-3 col-md-offset-3">
								<a class="btn btn-primary" href="/lendtotal"><i class="fa fa-fw fa-lg fa-check-circle"></i>Cancel</a>
							</div>
							<div class="col-md-3 col-md-offset-3">
