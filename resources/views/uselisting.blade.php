	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<a href="{{asset('image/Uselist upload Format.xlsx')}}" download>Sample Form</a>
			</div>
			<div class="modal-body">
				<form class="form-horizontal" method="POST" action="{{route('excelimport')}}" enctype="multipart/form-data">
					@csrf
...
<main class="app-content">
	<div class="app-title">
		<div>
			<h1><i class="fa-solid fa-table-list"></i>My Use Lists</h1>
		</div>
		<ul class="app-breadcrumb breadcrumb side">
			<li class="breadcrumb-item"><a href="/" title="Home"><i class="fa fa-home fa-lg"></i></a></li>
			<li class="breadcrumb-item">Tables</li>
			<li class="breadcrumb-item">My Use Lists</li>
		</ul>
	</div>
	<div class="row">
		<div class="col-md-12">
			<div class="tile">
				...
				<div class="tile-body">
					<div class="row">
						<div class="col-md-1">
							<a href="form/create" class="btn btn-info" title="Add New"><i class="fa-solid fa-plus"></i></a>
						</div>
						<div class="col-md-1">
					...
					<div class="table-responsive">
						<table class="table table-hover table-bordered" id="sampleTable">
							...
							<tbody>
								...
								@if(Auth::user()->id == $row->admin_id)
								<tr>
									<td>{{$i++}}</td>
									<td title="{{$row->date}}">{{$row->date}}</td>
									<td title="{{$row->total}} MMK">{{$row->total}} MMK</td>
									<td>
										<a href=" {{route('total.show',$row->id)}} " class="btn btn-info" title="Detail">
