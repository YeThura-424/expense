...
<main class="app-content">
	<div class="app-title">
		<div>
			<h1><i class="fa-solid fa-edit"></i>Create Category</h1>
		</div>
	...
	<div class="row">
		...
		<div class="col-md-6">
			<div class="tile">
				...
				@endif
				<h3 class="tile-title text-center">Add New Category Name</h3>
				<div class="tile-body">
					<form class="form-horizontal" method="POST" action="{{route('category.store')}}" enctype="multipart/form-data">
						...
						<div class="form-group row">
							...
							<div class="col-md-8">
								<input class="form-control @error('name') is-invalid @enderror" type="text" placeholder="Enter Category name" id="name" name="name">
								@error('name')
